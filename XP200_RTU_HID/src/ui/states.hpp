// todo this should not call into myMachine directly, have it emit a mesage to zbus instead. this should also subscribe to zbus to take in actions from machine, and witch it's own state. Or delete this SM, keep it simple style.

// #include "machine/basestates.hpp"
